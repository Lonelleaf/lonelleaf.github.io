...
function searchtext() {
    ...
    // 整合
    result.innerHTML = result.innerHTML.substring(0, result.innerHTML.length - 4) + textsearchresult.substring(0, textsearchresult.length - 4) + '<hr><a href="https://github.com/Loneleaf/RPageSearch" class="tr">Search powered by RavelloH\'s RPageSearch</a>'
}
